...
interface FinanceRecordViewEditFormProps {
  financeRecordData: {
    id: string;
...
export function FinanceRecordViewEditForm({
  financeRecordData,
  billingSettings,
  localityList,
  redirectPath = "/finance/registration",
}: FinanceRecordViewEditFormProps) {
  const [form, fields] = useForm({
    ...
    defaultValue: {
      id: financeRecordData.id,
      conferenceType: financeRecordData.conferenceType,
      registrationId: financeRecordData.registrationId || "",
      ssotRegistrationId: financeRecordData.ssotRegistrationId || "",
      billingSettingId: financeRecordData.billingSettingId,
    },
  });

  const fetcher = useFetcher();
  const [selectedConferenceType, setSelectedConferenceType] = useState(financeRecordData.conferenceType);
  const [selectedLocality, setSelectedLocality] = useState(financeRecordData.rawLocality);
    ...
    <div className="bg-gray-50">
      <div className="w-full flex flex-col">
        ...
        <Form
          ...
          {...getFormProps(form)}
        >
          <input type="hidden" name="id" value={financeRecordData.id} />
                  ...
                  <div>
                    <div className="space-y-1">
                      ...
                      <SelectBoxWithSearch
                        ...
                        defaultValue={financeRecordData.conferenceType}
                  ...
                  <div>
                    <div className="space-y-1">
                      ...
                      <SelectBoxWithSearch
                        ...
                        defaultValue={selectedConferenceType === "CAMANAVA_SSOT" ? financeRecordData.ssotRegistrationId || "" : financeRecordData.registrationId || ""}
                  ...
                  <div>
                    <div className="space-y-1">
                      ...
                      <SelectBoxWithSearch
                        ...
                        defaultValue={financeRecordData.billingSettingId}
